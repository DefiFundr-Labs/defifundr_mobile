class AppTexts {
  ...
  static String createAccountDescription = "Enter your credentials to get started";
  static String termsAndConditions = "By creating an account, you agree to our ";
  ...
  static String forgotPasswordDesc = "Ooops! don't worry,\nthe process is simpler than you thought";
  static String forgotPasswordButton = "Continue";
  static String resetPassword = "Reset Password";
  static String resetPasswordDesc = "Enter your email or username to reset password";
  ...
  static String enterNewPasswordDesc = "Enter a new password to regain access to your account.";
  ...
  static String tellusmoreabouttheaccounttypetypeyouare = 'Tell us more about the account type type you are trying to open and keep us informed';
  static String whattypeofaccountareyoucreating = 'What type of account are you creating';
  static String createapersonalizedaccounttoempower = 'create a personalized account to empower your self and get paid from any where in the world';
  static String personalaccount = 'Personal account';
  static String empoweryourbusinessbyusingDefiFundrtopower = 'empower your business by using DefiFundr to power your business and transform your payroll';
  ...
  static String tellusaboutthetypeofpersonal = 'Tell us about the type of personal account you are trying to open ';
  ...
  static String weNotifiedthatyourprofilewasnot = "We Notified that your profile was not completed when you first created your account'";
  ...
  static String createFixedRateContract = "Create a Fixed Rate contract for individual contractors for your company";
  ...
  static String createAPersonalizedAccount = "create a personalized account to empower your self and get paid from any where in the world";
  static String empowerYourBusiness = "empower your business by using DefiFundr to power your business and transform your payroll";
  static String kindlyCreateContract = "Please kindly create a contract agreement details you'd like to share with your employer";
  ...
  static const String enterVotersCardNumber = "Enter your voters card number below";
  static const String enterEmailAddress = "Enter your email address to get a code to reset your password.";
  static const String sendCode = "Send code";
  static const String emailAddress = "Email address";

  // Payment Tracker Strings
  static const invoiceCreatedAndSent = 'Invoice created and sent to client';
  static const awaitingPaymentConfirmation = 'Awaiting payment confirmation';
  static const clientPaymentConfirmed = 'Client payment confirmed';
  static const clientPaymentOverdue = 'Client payment overdue';
  static const clientWillGetInvoiceAccess = 'Your client will get invoice access before it is due on ';
  static const paymentWasExpected = 'The payment was expected by ';
  static const paymentWasExpectedEnding = ' but has not yet been received.';
  static const processClientPayment = 'Process your client payment';
