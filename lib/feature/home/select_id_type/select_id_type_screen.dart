...
import 'package:defifundr_mobile/feature/home/select_id_type/widget/id_type_widget.dart';
      ...
      body: SafeArea(
        ...
        child: Column(
          ...
          children: [
            ...
            IdTypeWidget(title: AppTexts.ninSlip, onTap: () {}),
            SizedBox(height: 10.h),
            IdTypeWidget(title: AppTexts.votersCard, onTap: () {}),
            SizedBox(height: 10.h),
            IdTypeWidget(title: AppTexts.bvn, onTap: () {}),
            SizedBox(height: 10.h),
            IdTypeWidget(title: AppTexts.driversLicense, onTap: () {}),
            SizedBox(height: 10.h),
            IdTypeWidget(title: AppTexts.internationalPassport, onTap: () {}),
            SizedBox(height: 10.h),
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                    color: AppColors.activeButtonDark.withOpacity(0.5),
                    width: 0.5.w),
              ),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
