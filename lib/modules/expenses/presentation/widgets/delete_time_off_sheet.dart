...
class DeleteTimeOffSheet extends StatelessWidget {
  ...
  const DeleteTimeOffSheet({required this.expense});
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 4.h),
                      Text(
                        'Start Date: ${DateFormat('dd MMM yyyy').format(expense.expenseDate)}',
              ...
              Expanded(
                child: SecondaryButton(
                  ...
                  onPressed: () {
                    ...
                    AppSnackbar.show(context, 'Time off deleted successfully');
                  },
                ),
              ),
            ],
