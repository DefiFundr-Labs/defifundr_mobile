        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              _buildDetailRow(
                  'Submission date',
                  Text(_formatDate(expense.submissionDate),
                      style: TextStyle(fontWeight: FontWeight.w500))),
              _buildDetailRow(
                  'Amount',
                  Text('${expense.amount.toInt()} USDT',
                      style: TextStyle(fontWeight: FontWeight.w500))),
              ...
              _buildDetailRow(
                  'Attachment', _buildAttachmentButton(expense.attachment)),

              // Show rejection reason if rejected
              if (expense.status == ExpenseStatus.rejected) ...[
                SizedBox(height: 24),
                _buildDetailRow('Reason for rejection', null,
                    isDescription: true),
                Container(
                  width: double.infinity,
                  padding: EdgeInsets.symmetric(horizontal: 16, vertical: 8),
              ...
              SizedBox(height: 24),
              _buildDetailRow(
                  'Contract', _buildContractButton(expense.contract)),
              _buildDetailRow(
                  'Contract Type',
                  Text(expense.contractType ?? '',
                      style: TextStyle(fontWeight: FontWeight.w500))),
              _buildDetailRow(
                  'Client',
                  Text(expense.client ?? '',
