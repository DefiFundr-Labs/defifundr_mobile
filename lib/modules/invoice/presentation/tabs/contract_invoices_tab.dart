...
class ContractInvoicesTab extends StatelessWidget {
  const ContractInvoicesTab({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final List<Invoice> invoices = AppConstants.sampleContractInvoices;
