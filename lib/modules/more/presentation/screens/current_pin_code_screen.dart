...
@RoutePage()
class CurrentPinCodeScreen extends StatefulWidget {
  const CurrentPinCodeScreen({super.key});

  @override
  State<CurrentPinCodeScreen> createState() => _CurrentPinCodeScreenState();
}

class _CurrentPinCodeScreenState extends State<CurrentPinCodeScreen>
  ...
  void _verifyPin() {
    // In production this would validate against stored PIN
    if (_pin.join() == '1234') {
      context.router.push(const NewPinCodeRoute());
    } else {
      _handleIncorrectPin();
    }
  }
