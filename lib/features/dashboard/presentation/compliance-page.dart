...
class _ComplianceScreenState extends State<ComplianceScreen> {
  ...
  ValueNotifier<ComplianceTypeEnum> complianceType = ValueNotifier(ComplianceTypeEnum.aiGeneratedContract);
      ...
      appBar: AppBar(
        ...
        actions: [
          Container(
            ...
            decoration: BoxDecoration(shape: BoxShape.circle, border: Border.all(color: Color(0xff081A5F), width: 4)),
            child: Text(
              "100%",
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: Config.b3(context).copyWith(fontWeight: FontWeight.w400, fontSize: 16.sp, color: Color(0xff505780)),
              ),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Agreement',
                      style: Config.h3(context).copyWith(fontWeight: FontWeight.w500, fontSize: 16.sp),
                    ),
                    SizedBox(height: 4.h),
                    Text(
                    ...
                    ValueListenableBuilder(
                      ...
                      builder: (context, selectedOption, _) => SelectComplianceTypeListTile(
                  ...
                  children: [
                    ...
                    ValueListenableBuilder(
                      ...
                      builder: (context, file, _) => Expanded(
                        child: Text(
                          file != null ? file.getPreview(length: 5) : 'Upload Compliance',
                          style: Config.h3(context).copyWith(fontWeight: FontWeight.w500, fontSize: 16.sp),
                        ),
                      ),
                    ),
                  ...
                  children: [
                    ...
                    ValueListenableBuilder(
                        ...
                        builder: (context, file, _) {
                          return Expanded(
                            child: Text(
                              file != null ? file.getPreview(length: 5) : 'Upload Signature',
                              style: Config.h3(context).copyWith(fontWeight: FontWeight.w500, fontSize: 16.sp),
                            ),
                          );
                        }),
...
class SelectComplianceTypeListTile<T> extends StatelessWidget {
  ...
  const SelectComplianceTypeListTile({super.key, this.value, required this.onSelected, required this.list, required this.titleBuilder});
      ...
      children: list.map((item) {
        return GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(borderRadius: BorderRadius.circular(12.r), border: Border.all(color: Color(0xFFEBE8FD))),
            child: Row(
              children: [
                SvgPicture.asset(
                  value == item ? 'assets/icons/checked.svg' : 'assets/icons/unchecked.svg',
                  height: 16.h,
                  width: 16.w,
                  fit: BoxFit.contain,
                ),
                ...
                Text(
                  titleBuilder(item),
                  style: Config.b2(context).copyWith(fontWeight: FontWeight.w400, fontSize: 14.sp, color: item != value ? Color(0xFFBABABA) : null),
                ),
              ],
